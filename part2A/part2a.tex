...
\addcontentsline{toc}{section}{Usefull formulas}
...
%
%
\addcontentsline{toc}{section}{Exercise 2A.1}
...
%
%
\addcontentsline{toc}{section}{Exercise 2A.2}
...
%
%
\addcontentsline{toc}{section}{Exercise 2A.3}
...
\underline{\bf{Planet frame:}} The lights are emitted from the spaceship. Therefore, since the spaceship always is centered at the origin in the spaceship frame, the positions of the events (in the spaceship frame) are
...
%
%
\addcontentsline{toc}{section}{Exercise 2A.4}
...
%
%
\addcontentsline{toc}{section}{Exercise 2A.5}
...
%
%
\addcontentsline{toc}{section}{Exercise 2A.6}
...
\end{align}
%%%%%%%%%%%%%%%%%%%Har ikke fortegn på roten noe å si her?%%%%%%%%%%%%%%%%%%%%%%%
...
%
%
\addcontentsline{toc}{section}{Exercise 2A.7}
...
\item %Before we begin we remind you that the relative velocity to be $-v$. Hence we need to use this instead of $v$ in the Lorentz transformations.
%\\
%\\
...
%
%
\addcontentsline{toc}{section}{Exercise 2A.8}
